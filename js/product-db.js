/**
 * ProductDB — localStorage Database Layer for Gas Lê Minh
...
const ProductDB = (() => {
    ...
    const seedNews = [
        ...
        },
        {
            ...
            content: '<h2>Đảm bảo an toàn từ khâu lắp đặt</h2><p>Quá trình lắp bình gas cần sự cẩn trọng tuyệt đối. Phải đảm bảo van gas được vặn chặt, không có tiếng xì và không có mùi lạ. Tốt nhất, hãy để các kỹ thuật viên được đào tạo bài bản thực hiện việc này.</p><p>Gas Lê Minh cam kết kiểm tra an toàn 100% bằng bọt xà phòng mỗi khi giao gas.</p>',
